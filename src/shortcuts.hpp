...
inline std::vector<Shortcut>& getShortcuts()
{
    ...
    static std::vector<Shortcut> shortcuts {
        ...
        { Context::Buffer, Key(Modifiers::Ctrl | Modifiers::Shift, SpecialKey::Home), commands::moveCursorBof(true),
            "Move cursor to beginning of file" },
        ...
        { Context::Buffer, Key(Modifiers::Ctrl | Modifiers::Shift, SpecialKey::End), commands::moveCursorEof(true),
            "Move cursor to end of file while selecting" },
